 ...
 * 
 * Description: This file contains macros which are used to toggle the LEDs on the 
 * Uno32 board. This file is used included as a header in Lab07_main.c so that the 
 * macros defined in this file can be used in the toaster oven. 
 * 
 */
